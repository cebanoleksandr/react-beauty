...
const Sidebar = () => {
  ...
  return (
    <div className="fixed flex flex-col justify-between left-0 top-0 w-52 h-screen p-2 bg-pink-100 z-2 border-r border-r-white">
      <div>
        <Link to='/' className="text-pink-700 font-bold text-3xl p-2 block">BEAUTY</Link>

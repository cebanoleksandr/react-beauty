...
import { removeUserAC } from '../../storage/userSlice';
...
const Header = () => {
  ...
  return (
    <header className='fixed left-0 md:left-52 right-0 top-0 z-10 py-4 px-10 flex items-center justify-between bg-pink-50-100'>
